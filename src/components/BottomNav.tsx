...
const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-orange-50 to-amber-50/90 backdrop-blur-sm border-t border-orange-200/50 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]" style={{ paddingBottom: 'max(env(safe-area-inset-bottom), 24px)' }}>
